export default function RiverEdge() {
  return (
    <div className="relative w-full min-h-screen md:h-screen bg-[url('https://res.cloudinary.com/dybw1km5u/image/upload/v1777297164/ccd703603d8fceddc1d10cc8786d256c71fbb790_ispwjt.jpg')] bg-cover bg-center flex items-center px-5 sm:px-10 md:px-20 text-white overflow-hidden" style={{boxShadow: '0 -12px 40px rgba(0,0,0,0.5)'}}>
